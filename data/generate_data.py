...
def generate_abm_simulation_data(n_consumers: int = 200, n_steps: int = 100, seed: int = 42) -> pd.DataFrame:
    """
    ...
    for t in range(n_steps):
        ...
        market_shares.append(share * 100)
        
        # Clustering coefficient
        clustering = 0.5 + 0.3 * np.random.rand()
